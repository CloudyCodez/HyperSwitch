...
- Includes a Recovery Center for recent rollback backups, support exports, and handoff notes
- Can check GitHub Releases and self-apply a newer portable build when one is available
